...
urlpatterns = [
    ...
    path('api/mobile/check-version/', api_mobile.check_app_version),
...
urlpatterns += [
    ...
    path('api/mobile/manager/attendance/export/excel/', api_employee_profile.manager_attendance_export_excel),
    path('api/mobile/manager/attendance/export/pdf/', api_employee_profile.manager_attendance_export_pdf),
    path('api/mobile/manager/leaves/list/', api_employee_profile.manager_leaves_list),
    path('api/mobile/manager/leaves/export/excel/', api_employee_profile.manager_leaves_export_excel),
    path('api/mobile/manager/leaves/export/pdf/', api_employee_profile.manager_leaves_export_pdf),
    path('api/mobile/manager/requests/export/excel/', api_employee_profile.manager_requests_export_excel),
    path('api/mobile/manager/requests/export/pdf/', api_employee_profile.manager_requests_export_pdf),
    path('api/mobile/manager/payroll/export-current/excel/', api_employee_profile.manager_payroll_export_excel),
    path('api/mobile/manager/payroll/export-current/pdf/', api_employee_profile.manager_payroll_export_pdf),
    path('api/mobile/manager/missions/export/excel/', api_employee_profile.manager_missions_export_excel),
    path('api/mobile/manager/missions/export/pdf/', api_employee_profile.manager_missions_export_pdf),
    path('api/mobile/manager/reports/absence/export/excel/', api_employee_profile.manager_absence_export_excel),
    path('api/mobile/manager/reports/absence/export/pdf/', api_employee_profile.manager_absence_export_pdf),
    path('api/mobile/manager/reports/late/export/excel/', api_employee_profile.manager_late_export_excel),
    path('api/mobile/manager/reports/late/export/pdf/', api_employee_profile.manager_late_export_pdf),
    path('api/mobile/manager/reports/work-hours/export/excel/', api_employee_profile.manager_work_hours_export_excel),
    path('api/mobile/manager/reports/work-hours/export/pdf/', api_employee_profile.manager_work_hours_export_pdf),
    path('api/mobile/manager/reports/monthly-attendance/export/excel/', api_employee_profile.manager_monthly_attendance_export_excel),
    path('api/mobile/manager/reports/monthly-attendance/export/pdf/', api_employee_profile.manager_monthly_attendance_export_pdf),
    path('api/mobile/manager/reports/permissions-report/export/excel/', api_employee_profile.manager_permissions_report_export_excel),
    path('api/mobile/manager/reports/permissions-report/export/pdf/', api_employee_profile.manager_permissions_report_export_pdf),
    path('api/mobile/manager/reports/personal-location/export/excel/', api_employee_profile.manager_personal_location_export_excel),
