"""
============================================================
Patch 12b: إصلاح Seed للاشتراكات
============================================================
إضافة الميزات والخطط الافتراضية
============================================================
"""
...
# إصلاح مشكلة الـ encoding في Windows
...
def seed():
    ...
    print(f"\n[OK] Added {created_count} new features")
    print(f"[OK] Total features: {FeatureFlag.objects.count()}")
    print()
    
    print("[2/2] Adding Plans...")
    print("-" * 60)
    ...
    print(f"  [+] Trial Plan (14 days, all features)")
    ...
    print(f"  [+] Starter (15 employees, 299/month)")
    ...
    print(f"  [+] Business (50 employees, 599/month)")
    ...
    print(f"  [+] Professional (100 employees, 999/month)")
    ...
    print(f"  [+] Enterprise (unlimited, 2000/month)")
    
    print()
    print("=" * 60)
    print("Summary:")
    print(f"  Total Features: {FeatureFlag.objects.count()}")
    print(f"  Total Plans: {SubscriptionPlan.objects.count()}")
    print("=" * 60)
    print()
    print("[SUCCESS] All data added successfully!")
