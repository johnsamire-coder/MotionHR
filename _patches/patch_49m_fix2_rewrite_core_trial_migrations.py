"""
Patch 49M Fix2 — Rewrite Core Trial Migrations Properly

الهدف:
- إصلاح SyntaxError في core/migrations/0001_initial.py
- إعادة كتابة 0001_initial.py بشكل صحيح
- إعادة كتابة 0002_enhanced_trial_signup.py كـ no-op migration آمنة
- التأكد من وجود __init__.py داخل core/migrations

هذا الباتش supersedes:
- Patch 49M Fix1
"""
...
print("=" * 70)
print("Patch 49M Fix2 — Rewrite Core Trial Migrations Properly")
print("=" * 70)

# ────────────────────────────────────────────────────────────
# Backups
# ────────────────────────────────────────────────────────────
backup_if_exists("core/migrations/0001_initial.py", "core_migrations_0001_initial_before_49m_fix2.py.bak")
backup_if_exists("core/migrations/0002_enhanced_trial_signup.py", "core_migrations_0002_before_49m_fix2.py.bak")

# ────────────────────────────────────────────────────────────
# Step 1: ensure __init__.py
# ────────────────────────────────────────────────────────────
print("\n📌 Step 1: إنشاء core/migrations/__init__.py")
write_file("core/migrations/__init__.py", "")

# ────────────────────────────────────────────────────────────
# Step 2: rewrite 0001_initial.py correctly
# ────────────────────────────────────────────────────────────
print("\n📌 Step 2: إعادة كتابة core/migrations/0001_initial.py")
...
# ────────────────────────────────────────────────────────────
# Step 3: rewrite 0002_enhanced_trial_signup.py as safe no-op
# ────────────────────────────────────────────────────────────
print("\n📌 Step 3: إعادة كتابة core/migrations/0002_enhanced_trial_signup.py")
...
class Migration(migrations.Migration):
    ...
    operations = [
        # No-op migration
        # النسخة النهائية من TrialSignupLead موجودة بالفعل في 0001_initial
    ]
"""
...
# ────────────────────────────────────────────────────────────
print("\n📌 Step 4: فحص Syntax")
compile_check("core/migrations/0001_initial.py")
compile_check("core/migrations/0002_enhanced_trial_signup.py")

print("\n" + "=" * 70)
print("✅ Patch 49M Fix2 اكتمل")
print("=" * 70)
print("""
اللي اتعمل:
  ✅ إعادة كتابة core/migrations/0001_initial.py بشكل صحيح
  ✅ إزالة القوس الزائد الذي سبب SyntaxError
  ✅ إعادة كتابة core/migrations/0002_enhanced_trial_signup.py كـ no-op migration
  ✅ فحص syntax بنجاح
