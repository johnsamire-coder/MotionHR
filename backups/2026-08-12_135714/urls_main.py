...
urlpatterns = [
    path('attendance/api/mobile/manager/reports2/', include('attendance.urls_new_reports')),
    path('attendance/api/mobile/manager/reports/', include('attendance.urls_new_reports')),
